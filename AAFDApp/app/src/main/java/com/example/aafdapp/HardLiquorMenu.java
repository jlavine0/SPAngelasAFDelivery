...
import com.example.aafdapp.databinding.ActivityHardLiquorMenuBinding;


public class HardLiquorMenu extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private ActivityHardLiquorMenuBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_hard_liquor_menu);
        snackbarLayout = findViewById(R.id.hard_liquor_layout);
    ...
    private void requestLocationPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(snackbarLayout, R.string.location_access_required, Snackbar.LENGTH_INDEFINITE).setAction(R.string.ok, new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ActivityCompat.requestPermissions(HardLiquorMenu.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, PERMISSION_REQUEST_LOCATION);
                }
            }).show();
        } else {
            Snackbar.make(snackbarLayout, R.string.location_unavailable, Snackbar.LENGTH_SHORT).show();
