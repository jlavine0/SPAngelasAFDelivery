...
import com.example.aafdapp.databinding.ActivityWineMenuBinding;


public class WineMenu extends AppCompatActivity implements ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    private ActivityWineMenuBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_wine_menu);
        snackbarLayout = findViewById(R.id.wine_layout);
    ...
    private void requestLocationPermission() {
        ...
        if (ActivityCompat.shouldShowRequestPermissionRationale(this,
            ...
            Snackbar.make(snackbarLayout, R.string.location_access_required, Snackbar.LENGTH_INDEFINITE).setAction(R.string.ok, new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    ActivityCompat.requestPermissions(WineMenu.this, new String[]{Manifest.permission.ACCESS_FINE_LOCATION}, PERMISSION_REQUEST_LOCATION);
                }
            }).show();
        } else {
            Snackbar.make(snackbarLayout, R.string.location_unavailable, Snackbar.LENGTH_SHORT).show();
