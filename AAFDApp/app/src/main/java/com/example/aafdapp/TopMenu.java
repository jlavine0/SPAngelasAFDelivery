...
import com.example.aafdapp.databinding.ActivityTopMenuBinding;
...
public class TopMenu extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavController navController = Navigation.findNavController(this, R.id.nav_host_fragment_content_top_menu);
